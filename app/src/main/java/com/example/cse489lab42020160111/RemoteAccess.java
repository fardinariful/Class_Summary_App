...
public class RemoteAccess {
    ...
    public String removeLectureSummary(String baseUrl, String studentId, String semester, String lectureId) {
        String url = baseUrl + "?action=remove&sid=" + studentId + "&semester=" + semester + "&id=" + lectureId;
